...
function getDate(input, attr) {
    ...
    if(!input && !attr) return moment().format('YYYY-MM-DD HH:mm:ss');
        ...
        if(input && attr){
            switch(attr){
                case 'hours':
                    return moment().add(input, 'hours').format('YYYY-MM-DD HH:mm:ss');
                case 'days':
                    return moment().add(input, 'days').format('YYYY-MM-DD HH:mm:ss');
                case 'months':
                    return moment().add(input, 'months').format('YYYY-MM-DD HH:mm:ss');
                case 'years':
                    return moment().add(input, 'years').format('YYYY-MM-DD HH:mm:ss');
                default:
